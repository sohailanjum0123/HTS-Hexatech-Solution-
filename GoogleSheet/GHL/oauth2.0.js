...
function appointTest() {
  const appointmentData = {
    "practice_id": "bostonvitalityemr.md-hq.com",
    "event_type": "schedule.created",
    "data": {
      "id": "25709",
      "start": "2024-09-26 13:00:00",
      "end": "2024-09-26 13:30:00",
      ...
      "addedby": {
        ...
        "state_license_id": "",
        "erx_authorized": "0",
        "email": "mray@bostonvitality.com",
        "role_2": "",
        "assignable_tasks": "0",
        "assignable_documents": "1",
        "assignable_soaps": "0",
        "assignable_charges": "",
        "portal_messages_allowed": "0",
        "portal_messages_display_name": "",
        "portal_appointment_request_display_name": "Mike Ray",
        "user_notes": "",
        "employment_time": "1",
        "cosign_required": "1",
        "disabled": "0",
        "addedby": "8",
        "dateadded": "2020-09-21 09:50:17",
        "datedeleted": "0000-00-00 00:00:00"
      },
      "removed": "0",
      "dateadded": "2024-09-24 14:11:13",
      "deletedby": null,
      "datedeleted": null,
      "assigned_providers": [
        {
          ...
          "state_license_id": "",
          "erx_authorized": "1",
          "email": "patrickcooke721@gmail.com",
          "role_2": "PA (if seeing patients independently)",
          "assignable_tasks": "1",
          "assignable_documents": "1",
          "assignable_soaps": "0",
          "assignable_charges": "",
          "portal_messages_allowed": "0",
          "portal_messages_display_name": "",
          "portal_appointment_request_display_name": "",
          "user_notes": "",
          "employment_time": "3",
          "cosign_required": "1",
          "disabled": "0",
          "addedby": "8",
          "dateadded": "2023-04-18 11:09:01",
          "datedeleted": "0000-00-00 00:00:00"
        }
      ],
      "appointment_type": "Initial Examination",
      "patient": {
        "id": "832",
        "first": "Sean",
        "middle": "",
        ...
        "fullscript_id": null,
        "active_campaign_id": "",
        "email1": "sclark@bostonvitality.com",
        "email2": "",
        "skype_name": "",
        "phone_home": "(978) 390-7388",
        "phone_mobile": "",
        "phone_work": "",
        "phone_other": "",
        "primary_phone": "9",
        ...
        "portal_access": true,
        "inactive": false,
        "inactive_date": "0000-00-00 00:00:00",
        "addedby": "1",
        "dateadded": "0000-00-00 00:00:00",
        "lastupdated": "2023-09-08 15:06:30",
        "updatedby": "8"
      }
    },
    "date_sent": "2024-09-24 14:11:13",
    "trigged_by": {
      "id": "14",
      "first": "MIchael",
      "middle": "",
  ...
  appointmentCreater(appointmentData);
}
...
function addToBackground(func, time = 5) {
  ScriptApp.newTrigger(func)
    .timeBased()
    .after(time * 1000) // Schedule to run after 1 minute
    .create();
}
...
function doGet(e) {
  ...
  if (code != '') {
    ...
    if (action == "fullUrl") {
      ...
      return HtmlService.createHtmlOutput(
        `<a href="${fullurl}" target="_blank">Click Here to Connect</a>`
      );
    }
