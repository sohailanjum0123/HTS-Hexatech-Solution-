(() => {
    ...
    right: 4.7%;
        ...
        waitElement("header.hl_header .hl_header--controls").then((beforeController) => {
            if (beforeController) {
                beforeController.insertAdjacentHTML("beforebegin", controlsHTML);
                ...
                toggleButton.addEventListener("click", () => {
                    ...
                    toggleButton.textContent = controlsVisible ? "Controls" : "Controls";
                });
